...
##CONNECT TO DB
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///C:/Users/galag/PycharmProjects/DAY 69/blog.db'
...
def show_post(post_id):
    ...
    if form.validate_on_submit():
        if current_user.is_authenticated:
            ...
            return redirect(url_for("login"))
    return render_template("post.html", post=requested_post, logged_in=current_user, form=form, comments=comments)
